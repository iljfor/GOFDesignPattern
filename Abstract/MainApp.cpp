...
int main()
{
	...
	//MazeFactory* lpMazeFactory = new MazeFactory;
	//MazeFactory* lpMazeFactory = new EnchantedMazeFactory;
	MazeFactory* lpMazeFactory = new BombedMazeFactory;
	if (NULL == lpMazeFactory)
		return 0;

	Maze* lpMaze = lpMazeGate->CreateMaze(*lpMazeFactory);
	if (NULL == lpMaze)
		return 0;
